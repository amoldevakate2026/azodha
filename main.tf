...
resource "aws_iam_role_policy_attachment" "azodha-AmazonEKSClusterPolicy" {
...
#cluster provision
resource "aws_eks_cluster" "azodha" {
  name     = "EKS_CLOUD"
  role_arn = aws_iam_role.azodha.arn
  ...
  depends_on = [
    aws_iam_role_policy_attachment.azodha-AmazonEKSClusterPolicy,
  ]
}
...
resource "aws_eks_node_group" "azodha" {
  ...
  depends_on = [
    aws_iam_role_policy_attachment.azodha-AmazonEKSWorkerNodePolicy,
    aws_iam_role_policy_attachment.azodha-AmazonEKS_CNI_Policy,
    aws_iam_role_policy_attachment.azodha-AmazonEC2ContainerRegistryReadOnly,
  ]
}
